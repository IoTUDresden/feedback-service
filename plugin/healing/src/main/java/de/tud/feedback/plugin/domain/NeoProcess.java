...
public class NeoProcess {
    ...
    @Relationship(type = "REMOTE_FOR", direction = Relationship.OUTGOING)
    private NeoProcess originalProcess;
    ...
    public NeoProcess getOriginalProcess() {
        return originalProcess;
    }

    public void setOriginalProcess(NeoProcess originalProcess) {
